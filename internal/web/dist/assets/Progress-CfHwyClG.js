import{$t as e,A as t,B as n,D as r,Dt as i,Gt as a,H as o,Lt as s,Nt as c,Ot as l,Pn as u,U as d,Xt as f,Yt as p,Zt as m,hn as h,jt as g,k as _,nn as v,q as y}from"./client-HeelZ21K.js";import{B as b,R as x,V as S,et as C,y as w,z as T}from"./index-DWif4xih.js";var E=[`id`],D=[`stop-color`],O=[`stop-color`],k=[`viewBox`],A=[`d`,`stroke-width`],j=[`d`,`stroke-width`],M={success:(h(),m(T)),error:(h(),m(S)),warning:(h(),m(x)),info:(h(),m(b))},N=v({name:`ProgressCircle`,props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(t,{slots:i}){let o=p(()=>{let e=`gradient`,{fillColor:n}=t;return typeof n==`object`?`${e}-${s(JSON.stringify(n))}`:e});function c(e,n,r,i){let{gapDegree:a,viewBoxWidth:s,strokeWidth:c}=t,l=50+c/2,u=`M ${l},${l} m 0,50
      a 50,50 0 1 1 0,-100
