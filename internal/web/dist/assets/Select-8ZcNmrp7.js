...
`,[v(`scrollbar`,`
 ...
 text-overflow: ellipsis;
 overflow: hidden;
 `)])])]),Ln=[`disabled`,`value`,`autofocus`,`onBlur`,`onFocus`,`onKeydown`,`onInput`,`onCompositionstart`,`onCompositionend`],Rn=[`tabindex`],zn=[`title`],Bn=[`value`,`readonly`,`disabled`,`autofocus`,`onFocus`,`onBlur`,`onInput`,`onCompositionstart`,`onCompositionend`],Vn=[`tabindex`],Hn=[`onClick`,`onMouseenter`,`onMouseleave`,`onKeydown`,`onFocusin`,`onFocusout`,`onMousedown`],Un=U({name:`InternalSelection`,props:{...V.props,clsPrefix:{type:String,required:!0},bordered:{type:Boolean,default:void 0},active:Boolean,pattern:{type:String,default:``},placeholder:String,selectedOption:{type:Object,default:null},selectedOptions:{type:Array,default:null},labelField:{type:String,default:`label`},valueField:{type:String,default:`value`},multiple:Boolean,filterable:Boolean,clearable:Boolean,disabled:Boolean,size:{type:String,default:`medium`},loading:Boolean,autofocus:Boolean,showArrow:{type:Boolean,default:!0},inputProps:Object,focused:Boolean,renderTag:Function,onKeydown:Function,onClick:Function,onBlur:Function,onFocus:Function,onDeleteOption:Function,maxTagCount:[String,Number],ellipsisTagPopoverProps:Object,onClear:Function,onPatternInput:Function,onPatternFocus:Function,onPatternBlur:Function,renderLabel:Function,status:String,inlineThemeDisabled:Boolean,ignoreComposition:{type:Boolean,default:!0},onResize:Function},setup(e){let{mergedClsPrefixRef:n,mergedRtlRef:r}=ie(e),i=te(`InternalSelection`,r,n),a=_(null),o=_(null),s=_(null),c=_(null),l=_(null),u=_(null),d=_(null),f=_(null),p=_(null),h=_(null),v=_(!1),y=_(!1),b=_(!1),x=V(`InternalSelection`,`-internal-selection`,In,Ae,e,z(e,`clsPrefix`)),S=O(()=>e.clearable&&!e.disabled&&(b.value||e.active)),C=O(()=>e.selectedOption?e.renderTag?e.renderTag({option:e.selectedOption,handleClose:()=>{}}):e.renderLabel?e.renderLabel(e.selectedOption,!0):de(e.selectedOption[e.labelField],e.selectedOption,!0):e.placeholder),w=O(()=>{let t=e.selectedOption;if(t)return t[e.labelField]}),T=O(()=>e.multiple?!!(Array.isArray(e.selectedOptions)&&e.selectedOptions.length):e.selectedOption!==null);function E(){let{value:t}=a;if(t){let{value:n}=o;n&&(n.style.width=`${t.offsetWidth}px`,e.maxTagCount!==`responsive`&&p.value?.sync({showAllItemsBeforeCalculate:!1}))}}function D(){let{value:e}=h;e&&(e.style.display=`none`)}function k(){let{value:e}=h;e&&(e.style.display=`inline-block`)}j(z(e,`active`),e=>{e||D()}),j(z(e,`pattern`),()=>{e.multiple&&q(E)});function A(t){let{onFocus:n}=e;n&&n(t)}function ee(t){let{onBlur:n}=e;n&&n(t)}function M(t){let{onDeleteOption:n}=e;n&&n(t)}function N(t){let{onClear:n}=e;n&&n(t)}function P(t){let{onPatternInput:n}=e;n&&n(t)}function F(e){(!e.relatedTarget||!s.value?.contains(e.relatedTarget))&&A(e)}function I(e){s.value?.contains(e.relatedTarget)||ee(e)}function L(e){N(e)}function ne(){b.value=!0}function R(){b.value=!1}function B(t){!e.active||!e.filterable||t.target!==o.value&&t.preventDefault()}function H(e){M(e)}let U=_(!1);function W(t){if(t.key===`Backspace`&&!U.value&&!e.pattern.length){let{selectedOptions:t}=e;t?.length&&H(t[t.length-1])}}let G=null;function K(t){let{value:n}=a;n&&(n.textContent=t.target.value,E()),e.ignoreComposition&&U.value?G=t:P(t)}function J(){U.value=!0}function ae(){U.value=!1,e.ignoreComposition&&P(G),G=null}function Y(t){y.value=!0,e.onPatternFocus?.(t)}function X(t){y.value=!1,e.onPatternBlur?.(t)}function oe(){if(e.filterable)y.value=!1,u.value?.blur(),o.value?.blur();else if(e.multiple){let{value:e}=c;e?.blur()}else{let{value:e}=l;e?.blur()}}function Z(){e.filterable?(y.value=!1,u.value?.focus()):e.multiple?c.value?.focus():l.value?.focus()}function Q(){let{value:e}=o;e&&(k(),e.focus())}function $(){let{value:e}=o;e&&e.blur()}function ce(e){let{value:t}=d;t&&t.setTextContent(`+${e}`)}function le(){let{value:e}=f;return e}function ue(){return o.value}let fe=null;function pe(){fe!==null&&window.clearTimeout(fe)}function me(){e.active||(pe(),fe=window.setTimeout(()=>{T.value&&(v.value=!0)},100))}function he(){pe()}function ge(e){e||(pe(),v.value=!1)}j(T,e=>{e||(v.value=!1)}),re(()=>{se(()=>{let t=u.value;t&&(e.disabled?t.removeAttribute(`tabindex`):t.tabIndex=y.value?-1:0)})}),Lt(s,e.onResize);let{inlineThemeDisabled:_e}=e,ve=O(()=>{let{size:t}=e,{common:{cubicBezierEaseInOut:n},self:{fontWeight:r,borderRadius:i,color:a,placeholderColor:o,textColor:s,paddingSingle:c,paddingMultiple:l,caretColor:u,colorDisabled:d,textColorDisabled:f,placeholderColorDisabled:p,colorActive:h,boxShadowFocus:_,boxShadowActive:v,boxShadowHover:y,border:b,borderFocus:S,borderHover:C,borderActive:w,arrowColor:T,arrowColorDisabled:E,loadingColor:D,colorActiveWarning:O,boxShadowFocusWarning:k,boxShadowActiveWarning:A,boxShadowHoverWarning:ee,borderWarning:j,borderFocusWarning:M,borderHoverWarning:N,borderActiveWarning:P,colorActiveError:F,boxShadowFocusError:te,boxShadowActiveError:I,boxShadowHoverError:L,borderError:ne,borderFocusError:R,borderHoverError:z,borderActiveError:B,clearColor:V,clearColorHover:H,clearColorPressed:U,clearSize:W,arrowSize:G,[g(`height`,t)]:re,[g(`fontSize`,t)]:ie}}=x.value,K=m(c),q=m(l);return{"--n-bezier":n,"--n-border":b,"--n-border-active":w,"--n-border-focus":S,"--n-border-hover":C,"--n-border-radius":i,"--n-box-shadow-active":v,"--n-box-shadow-focus":_,"--n-box-shadow-hover":y,"--n-caret-color":u,"--n-color":a,"--n-color-active":h,"--n-color-disabled":d,"--n-font-size":ie,"--n-height":re,"--n-padding-single-top":K.top,"--n-padding-multiple-top":q.top,"--n-padding-single-right":K.right,"--n-padding-multiple-right":q.right,"--n-padding-single-left":K.left,"--n-padding-multiple-left":q.left,"--n-padding-single-bottom":K.bottom,"--n-padding-multiple-bottom":q.bottom,"--n-placeholder-color":o,"--n-placeholder-color-disabled":p,"--n-text-color":s,"--n-text-color-disabled":f,"--n-arrow-color":T,"--n-arrow-color-disabled":E,"--n-loading-color":D,"--n-color-active-warning":O,"--n-box-shadow-focus-warning":k,"--n-box-shadow-active-warning":A,"--n-box-shadow-hover-warning":ee,"--n-border-warning":j,"--n-border-focus-warning":M,"--n-border-hover-warning":N,"--n-border-active-warning":P,"--n-color-active-error":F,"--n-box-shadow-focus-error":te,"--n-box-shadow-active-error":I,"--n-box-shadow-hover-error":L,"--n-border-error":ne,"--n-border-focus-error":R,"--n-border-hover-error":z,"--n-border-active-error":B,"--n-clear-size":W,"--n-clear-color":V,"--n-clear-color-hover":H,"--n-clear-color-pressed":U,"--n-arrow-size":G,"--n-font-weight":r}}),ye=_e?t(`internal-selection`,O(()=>e.size[0]),ve,e):void 0;return{mergedTheme:x,mergedClearable:S,mergedClsPrefix:n,rtlEnabled:i,patternInputFocused:y,filterablePlaceholder:C,label:w,selected:T,showTagsPanel:v,isComposing:U,counterRef:d,counterWrapperRef:f,patternInputMirrorRef:a,patternInputRef:o,selfRef:s,multipleElRef:c,singleElRef:l,patternInputWrapperRef:u,overflowRef:p,inputTagElRef:h,handleMouseDown:B,handleFocusin:F,handleClear:L,handleMouseEnter:ne,handleMouseLeave:R,handleDeleteOption:H,handlePatternKeyDown:W,handlePatternInputInput:K,handlePatternInputBlur:X,handlePatternInputFocus:Y,handleMouseEnterCounter:me,handleMouseLeaveCounter:he,handleFocusout:I,handleCompositionEnd:ae,handleCompositionStart:J,onPopoverUpdateShow:ge,focus:Z,focusInput:Q,blur:oe,blurInput:$,updateCounter:ce,getCounter:le,getTail:ue,renderLabel:e.renderLabel,cssVars:_e?void 0:ve,themeClass:ye?.themeClass,onRender:ye?.onRender}},render(){let{status:t,multiple:n,size:i,disabled:a,filterable:o,maxTagCount:s,bordered:c,clsPrefix:l,ellipsisTagPopoverProps:d,onRender:f,renderTag:p,renderLabel:m}=this;f?.();let h=s===`responsive`,g=typeof s==`number`,_=h||g,v=(L(),k(Ee,null,{default:()=>(L(),k(St,{clsPrefix:l,loading:this.loading,showArrow:this.showArrow,showClear:this.mergedClearable&&this.selected,onClear:this.handleClear},{default:()=>this.$slots.arrow?.()},1032,[`clsPrefix`,`loading`,`showArrow`,`showClear`,`onClear`]))},1024)),b;if(n){let{labelField:t}=this,n=n=>(L(),e(`div`,{class:r(`${l}-base-selection-tag-wrapper`),key:n.value},[p?(L(),e(u,{key:0},[C(()=>p({option:n,handleClose:()=>{this.handleDeleteOption(n)}}))],64)):(L(),k(ce,{key:1,size:i,closable:!n.disabled,disabled:a,onClose:()=>{this.handleDeleteOption(n)},internalCloseIsButtonTag:!1,internalCloseFocusable:!1},{default:()=>m?m(n,!0):de(n[t],n,!0)},1032,[`size`,`closable`,`disabled`,`onClose`]))],2)),c=()=>(g?this.selectedOptions.slice(0,s):this.selectedOptions).map(n),f=o?(L(),e(`div`,{class:r(`${l}-base-selection-input-tag`),ref:`inputTagElRef`,key:`__input-tag__`},[E(`input`,G(this.inputProps,{ref:`patternInputRef`,tabindex:-1,disabled:a,value:this.pattern,autofocus:this.autofocus,class:`${l}-base-selection-input-tag__input`,onBlur:this.handlePatternInputBlur,onFocus:this.handlePatternInputFocus,onKeydown:this.handlePatternKeyDown,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd}),null,16,Ln),E(`span`,{ref:`patternInputMirrorRef`,class:r(`${l}-base-selection-input-tag__mirror`)},[C(()=>this.pattern)],2)],2)):null,y=h?()=>(L(),e(`div`,{class:r(`${l}-base-selection-tag-wrapper`),ref:`counterWrapperRef`},[(L(),k(ce,{size:i,ref:`counterRef`,onMouseenter:this.handleMouseEnterCounter,onMouseleave:this.handleMouseLeaveCounter,disabled:a},null,8,[`size`,`onMouseenter`,`onMouseleave`,`disabled`]))],2)):void 0,x;if(g){let t=this.selectedOptions.length-s;t>0&&(x=(n=>(L(),e(`div`,{class:r(`${l}-base-selection-tag-wrapper`),key:`__counter__`},[(L(),k(ce,{size:i,ref:`counterRef`,onMouseenter:this.handleMouseEnterCounter,disabled:a},{default:()=>`+${t}`},1032,[`size`,`onMouseenter`,`disabled`]))],2)))(x))}let S=h?o?(L(),k(pt,{key:3,ref:`overflowRef`,updateCounter:this.updateCounter,getCounter:this.getCounter,getTail:this.getTail,style:{width:`100%`,display:`flex`,overflow:`hidden`}},{default:c,counter:y,tail:()=>f},1032,[`updateCounter`,`getCounter`,`getTail`])):(L(),k(pt,{key:4,ref:`overflowRef`,updateCounter:this.updateCounter,getCounter:this.getCounter,style:{width:`100%`,display:`flex`,overflow:`hidden`}},{default:c,counter:y},1032,[`updateCounter`,`getCounter`])):g&&x?c().concat(x):c(),w=_?()=>(L(),e(`div`,{class:r(`${l}-base-selection-popover`)},[h?(L(),e(u,{key:0},[C(()=>c())],64)):(L(),e(u,{key:1},[C(()=>this.selectedOptions.map(n))],64))],2)):void 0,T=_?{show:this.showTagsPanel,trigger:`hover`,overlap:!0,placement:`top`,width:`trigger`,onUpdateShow:this.onPopoverUpdateShow,theme:this.mergedTheme.peers.Popover,themeOverrides:this.mergedTheme.peerOverrides.Popover,...d}:null,D=!this.selected&&(!this.active||!this.pattern&&!this.isComposing)?(L(),e(`div`,{key:5,class:r(`${l}-base-selection-placeholder ${l}-base-selection-overlay`)},[E(`div`,{class:r(`${l}-base-selection-placeholder__inner`)},[C(()=>this.placeholder)],2)],2)):null,O=o?(L(),e(`div`,{key:6,ref:`patternInputWrapperRef`,class:r(`${l}-base-selection-tags`)},[C(()=>S),h?C(()=>null):(L(),e(u,{key:1},[C(()=>f)],64)),C(()=>v)],2)):(L(),e(`div`,{key:7,ref:`multipleElRef`,class:r(`${l}-base-selection-tags`),tabindex:a?void 0:0},[C(()=>S),C(()=>v)],10,Rn));b=(t=>(L(),e(u,{key:8},[_?(L(),k(ye,G({key:0},T,{scrollable:!0,style:`max-height: calc(var(--v-target-height) * 6.6);`}),{trigger:()=>O,default:w},1040)):(L(),e(u,{key:1},[C(()=>O)],64)),C(()=>D)],64)))(b)}else if(o){let t=this.pattern||this.isComposing,n=this.active?!t:!this.selected,i=!this.active&&this.selected;b=(t=>(L(),e(`div`,{key:9,ref:`patternInputWrapperRef`,class:r(`${l}-base-selection-label`),title:this.patternInputFocused?void 0:mt(this.label)},[E(`input`,G(this.inputProps,{ref:`patternInputRef`,class:`${l}-base-selection-input`,value:this.active?this.pattern:``,placeholder:``,readonly:a,disabled:a,tabindex:-1,autofocus:this.autofocus,onFocus:this.handlePatternInputFocus,onBlur:this.handlePatternInputBlur,onInput:this.handlePatternInputInput,onCompositionstart:this.handleCompositionStart,onCompositionend:this.handleCompositionEnd}),null,16,Bn),i?(L(),e(`div`,{class:r(`${l}-base-selection-label__render-label ${l}-base-selection-overlay`),key:`input`},[E(`div`,{class:r(`${l}-base-selection-overlay__wrapper`)},[p?(L(),e(u,{key:0},[C(()=>p({option:this.selectedOption,handleClose:()=>{}}))],64)):(L(),e(u,{key:1},[m?(L(),e(u,{key:0},[C(()=>m(this.selectedOption,!0))],64)):(L(),e(u,{key:1},[C(()=>de(this.label,this.selectedOption,!0))],64))],64))],2)],2)):C(()=>null),n?(L(),e(`div`,{class:r(`${l}-base-selection-placeholder ${l}-base-selection-overlay`),key:`placeholder`},[E(`div`,{class:r(`${l}-base-selection-overlay__wrapper`)},[C(()=>this.filterablePlaceholder)],2)],2)):C(()=>null),C(()=>v)],10,zn)))(b)}else b=(t=>(L(),e(`div`,{key:10,ref:`singleElRef`,class:r(`${l}-base-selection-label`),tabindex:this.disabled?void 0:0},[this.label===void 0?(L(),e(`div`,{class:r(`${l}-base-selection-placeholder ${l}-base-selection-overlay`),key:`placeholder`},[E(`div`,{class:r(`${l}-base-selection-placeholder__inner`)},[C(()=>this.placeholder)],2)],2)):(L(),e(`div`,{class:r(`${l}-base-selection-input`),title:mt(this.label),key:`input`},[E(`div`,{class:r(`${l}-base-selection-input__content`)},[p?(L(),e(u,{key:0},[C(()=>p({option:this.selectedOption,handleClose:()=>{}}))],64)):(L(),e(u,{key:1},[m?(L(),e(u,{key:0},[C(()=>m(this.selectedOption,!0))],64)):(L(),e(u,{key:1},[C(()=>de(this.label,this.selectedOption,!0))],64))],64))],2)],10,[`title`])),C(()=>v)],10,Vn)))(b);return L(),e(`div`,{ref:`selfRef`,class:r([`${l}-base-selection`,this.rtlEnabled&&`${l}-base-selection--rtl`,this.themeClass,t&&`${l}-base-selection--${t}-status`,{[`${l}-base-selection--active`]:this.active,[`${l}-base-selection--selected`]:this.selected||this.active&&this.pattern,[`${l}-base-selection--disabled`]:this.disabled,[`${l}-base-selection--multiple`]:this.multiple,[`${l}-base-selection--focus`]:this.focused}]),style:y(this.cssVars),onClick:this.onClick,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onKeydown:this.onKeydown,onFocusin:this.handleFocusin,onFocusout:this.handleFocusout,onMousedown:this.handleMouseDown},[C(()=>b),c?(L(),e(`div`,{key:0,class:r(`${l}-base-selection__border`)},null,2)):C(()=>null),c?(L(),e(`div`,{key:2,class:r(`${l}-base-selection__state-border`)},null,2)):C(()=>null)],46,Hn)}}),Wn=s([v(`select`,`
 z-index: auto;
 outline: none;
 width: 100%;
 position: relative;
 ...
 `,[_e({originalTransition:`background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)`})])]),Gn={...V.props,to:Ie.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearCreatedOptionsOnClear:{type:Boolean,default:!0},clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},keyboard:{type:Boolean,default:!0},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,menuSize:{type:String},filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:`bottom-start`},widthMode:{type:String,default:`trigger`},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],ellipsisTagPopoverProps:Object,consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:`label`},valueField:{type:String,default:`value`},childrenField:{type:String,default:`children`},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:`show`},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},scrollbarProps:Object,onChange:[Function,Array],items:Array},Kn=U({name:`Select`,props:Gn,slots:Object,setup(e){let{mergedClsPrefixRef:n,mergedBorderedRef:r,namespaceRef:a,inlineThemeDisabled:o,mergedComponentPropsRef:s}=ie(e),c=V(`Select`,`-select`,Wn,ue,e,n),l=_(e.defaultValue),u=z(e,`value`),d=ke(u,l),f=_(!1),p=_(``),m=oe(e,[`items`,`options`]),h=_([]),g=_([]),v=O(()=>g.value.concat(h.value).concat(m.value)),y=O(()=>{let{filter:t}=e;if(t)return t;let{labelField:n,valueField:r}=e;return(e,t)=>{if(!t)return!1;let i=t[n];if(typeof i==`string`)return Mn(e,i);let a=t[r];return typeof a==`string`?Mn(e,a):typeof a==`number`&&Mn(e,String(a))}}),b=O(()=>{if(e.remote)return m.value;{let{value:t}=v,{value:n}=p;return!n.length||!e.filterable?t:Pn(t,y.value,n,e.childrenField)}}),x=O(()=>{let{valueField:t,childrenField:n}=e,r=Nn(t,n);return Dn(b.value,r)}),C=O(()=>Fn(v.value,e.valueField,e.childrenField)),w=_(!1),T=ke(z(e,`show`),w),E=_(null),D=_(null),k=_(null),{localeRef:A}=Ye(`Select`),ee=O(()=>e.placeholder??A.value.placeholder),M=[],N=_(new Map),P=O(()=>{let{fallbackOption:t}=e;if(t===void 0){let{labelField:t,valueField:n}=e;return e=>({[t]:String(e),[n]:e})}return t===!1?!1:e=>Object.assign(t(e),{value:e})});function F(t){let n=e.remote,{value:r}=N,{value:i}=C,{value:a}=P,o=[];return t.forEach(e=>{if(i.has(e))o.push(i.get(e));else if(n&&r.has(e))o.push(r.get(e));else if(a){let t=a(e);t&&o.push(t)}}),o}let te=O(()=>{if(e.multiple){let{value:e}=d;return Array.isArray(e)?F(e):[]}return null}),I=O(()=>{let{value:t}=d;return!e.multiple&&!Array.isArray(t)?t===null?null:F([t])[0]||null:null}),L=ae(e,{mergedSize:t=>{let{size:n}=e;if(n)return n;let{mergedSize:r}=t||{};return r?.value?r.value:s?.value?.Select?.size||`medium`}}),{mergedSizeRef:ne,mergedDisabledRef:R,mergedStatusRef:B}=L;function H(t,n){let{onChange:r,"onUpdate:value":a,onUpdateValue:o}=e,{nTriggerFormChange:s,nTriggerFormInput:c}=L;r&&i(r,t,n),o&&i(o,t,n),a&&i(a,t,n),l.value=t,s(),c()}function U(t){let{onBlur:n}=e,{nTriggerFormBlur:r}=L;n&&i(n,t),r()}function W(){let{onClear:t}=e;t&&i(t)}function G(t){let{onFocus:n,showOnFocus:r}=e,{nTriggerFormFocus:a}=L;n&&i(n,t),a(),r&&Y()}function re(t){let{onSearch:n}=e;n&&i(n,t)}function K(t){let{onScroll:n}=e;n&&i(n,t)}function q(){let{remote:t,multiple:n}=e;if(t){let{value:t}=N;if(n){let{valueField:n}=e;te.value?.forEach(e=>{t.set(e[n],e)})}else{let n=I.value;n&&t.set(n[e.valueField],n)}}}function J(t){let{onUpdateShow:n,"onUpdate:show":r}=e;n&&i(n,t),r&&i(r,t),w.value=t}function Y(){R.value||(J(!0),w.value=!0,e.filterable&&De())}function X(){J(!1)}function Z(){p.value=``,g.value=M}let se=_(!1);function Q(){e.filterable&&(se.value=!0)}function $(){e.filterable&&(se.value=!1,T.value||Z())}function ce(){R.value||(T.value?e.filterable?De():X():Y())}function le(e){k.value?.selfRef?.contains(e.relatedTarget)||(f.value=!1,U(e),X())}function de(e){G(e),f.value=!0}function fe(){f.value=!0}function pe(e){E.value?.$el.contains(e.relatedTarget)||(f.value=!1,U(e),X())}function me(){E.value?.focus(),X()}function he(e){T.value&&(E.value?.$el.contains(Pe(e))||X())}function _e(t){if(!Array.isArray(t))return[];if(P.value)return Array.from(t);{let{remote:n}=e,{value:r}=C;if(n){let{value:e}=N;return t.filter(t=>r.has(t)||e.has(t))}return t.filter(e=>r.has(e))}}function ve(e){ye(e.rawNode)}function ye(t){if(R.value)return;let{tag:n,remote:r,clearFilterAfterSelect:i,valueField:a}=e;if(n&&!r){let{value:e}=g,t=e[0]||null;if(t){let e=h.value;e.length?e.push(t):h.value=[t],g.value=M}}if(r&&N.value.set(t[a],t),e.multiple){let e=_e(d.value),o=e.findIndex(e=>e===t[a]);if(~o){if(e.splice(o,1),n&&!r){let e=be(t[a]);~e&&(h.value.splice(e,1),i&&(p.value=``))}}else e.push(t[a]),i&&(p.value=``);H(e,F(e))}else{if(n&&!r){let e=be(t[a]);~e?h.value=[h.value[e]]:h.value=M}Ee(),X(),H(t[a],t)}}function be(t){return h.value.findIndex(n=>n[e.valueField]===t)}function xe(t){T.value||Y();let{value:n}=t.target;p.value=n;let{tag:r,remote:i}=e;if(re(n),r&&!i){if(!n){g.value=M;return}let{onCreate:t}=e,r=t?t(n):{[e.labelField]:n,[e.valueField]:n},{valueField:i,labelField:a}=e;m.value.some(e=>e[i]===r[i]||e[a]===r[a])||h.value.some(e=>e[i]===r[i]||e[a]===r[a])?g.value=M:g.value=[r]}}function Se(t){t.stopPropagation();let{multiple:n,tag:r,remote:i,clearCreatedOptionsOnClear:a}=e;!n&&e.filterable&&X(),r&&!i&&a&&(h.value=M),W(),n?H([],[]):H(null,null)}function Ce(e){!Je(e,`action`)&&!Je(e,`empty`)&&!Je(e,`header`)&&e.preventDefault()}function we(e){K(e)}function Te(t){if(!e.keyboard){t.preventDefault();return}switch(t.key){case` `:if(e.filterable)break;t.preventDefault();case`Enter`:if(!E.value?.isComposing){if(T.value){let t=k.value?.getPendingTmNode();t?ve(t):e.filterable||(X(),Ee())}else if(Y(),e.tag&&se.value){let t=g.value[0];if(t){let n=t[e.valueField],{value:r}=d;e.multiple&&Array.isArray(r)&&r.includes(n)||ye(t)}}}t.preventDefault();break;case`ArrowUp`:if(t.preventDefault(),e.loading)return;T.value&&k.value?.prev();break;case`ArrowDown`:if(t.preventDefault(),e.loading)return;T.value?k.value?.next():Y();break;case`Escape`:T.value&&(ge(t),X()),E.value?.focus()}}function Ee(){E.value?.focus()}function De(){E.value?.focusInput()}function Oe(){T.value&&D.value?.syncPosition()}q(),j(z(e,`options`),q);let Ae={focus:()=>{E.value?.focus()},focusInput:()=>{E.value?.focusInput()},blur:()=>{E.value?.blur()},blurInput:()=>{E.value?.blurInput()}},je=O(()=>{let{self:{menuBoxShadow:e}}=c.value;return{"--n-menu-box-shadow":e}}),Me=o?t(`select`,void 0,je,e):void 0;return{...Ae,mergedStatus:B,mergedClsPrefix:n,mergedBordered:r,namespace:a,treeMate:x,isMounted:S(),triggerRef:E,menuRef:k,pattern:p,uncontrolledShow:w,mergedShow:T,adjustedTo:Ie(e),uncontrolledValue:l,mergedValue:d,followerRef:D,localizedPlaceholder:ee,selectedOption:I,selectedOptions:te,mergedSize:ne,mergedDisabled:R,focused:f,activeWithoutMenuOpen:se,inlineThemeDisabled:o,onTriggerInputFocus:Q,onTriggerInputBlur:$,handleTriggerOrMenuResize:Oe,handleMenuFocus:fe,handleMenuBlur:pe,handleMenuTabOut:me,handleTriggerClick:ce,handleToggle:ve,handleDeleteOption:ye,handlePatternInput:xe,handleClear:Se,handleTriggerBlur:le,handleTriggerFocus:de,handleKeydown:Te,handleMenuAfterLeave:Z,handleMenuClickOutside:he,handleMenuScroll:we,handleMenuKeydown:Te,handleMenuMousedown:Ce,mergedTheme:c,cssVars:o?void 0:je,themeClass:Me?.themeClass,onRender:Me?.onRender}},render(){return L(),e(`div`,{class:r(`${this.mergedClsPrefix}-select`)},[J(le,null,{_:1,default:w(()=>[(L(),k(ve,null,{_:1,default:w(()=>(L(),k(Un,{ref:`triggerRef`,inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,ellipsisTagPopoverProps:this.ellipsisTagPopoverProps,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{_:1,arrow:w(()=>[this.$slots.arrow?.()])},8,`inlineThemeDisabled.status.inputProps.clsPrefix.showArrow.maxTagCount.ellipsisTagPopoverProps.bordered.active.pattern.placeholder.selectedOption.selectedOptions.multiple.renderTag.renderLabel.filterable.clearable.disabled.size.theme.labelField.valueField.themeOverrides.loading.focused.onClick.onDeleteOption.onPatternInput.onClear.onBlur.onFocus.onKeydown.onPatternBlur.onPatternFocus.onResize.ignoreComposition`.split(`.`))))})),(L(),k(me,{ref:`followerRef`,show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===Ie.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?`target`:void 0,minWidth:`target`,placement:this.placement},{_:1,default:w(()=>(L(),k(x,{name:`fade-in-scale-up-transition`,appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{_:1,default:w(()=>this.mergedShow||this.displayDirective===`show`?(this.onRender?.(),a((L(),k(kn,G(this.menuProps,{ref:`menuRef`,onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,this.menuProps?.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:this.menuSize,renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[this.menuProps?.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange,scrollbarProps:this.scrollbarProps}),{_:1,empty:w(()=>[this.$slots.empty?.()]),header:w(()=>[this.$slots.header?.()]),action:w(()=>[this.$slots.action?.()])},16,`onResize.inlineThemeDisabled.virtualScroll.class.clsPrefix.labelField.valueField.nodeProps.theme.themeOverrides.treeMate.multiple.size.renderOption.renderLabel.value.style.onToggle.onScroll.onFocus.onBlur.onKeydown.onTabOut.onMousedown.show.showCheckmark.resetMenuOnOptionsChange.scrollbarProps`.split(`.`))),this.displayDirective===`show`?[[d,this.mergedShow],[Se,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[Se,this.handleMenuClickOutside,void 0,{capture:!0}]])):null)},8,[`appear`,`onAfterLeave`])))},8,[`show`,`to`,`teleportDisabled`,`containerClass`,`width`,`placement`]))])})],2)}});export{Je as i,It as n,Ye as r,Kn as t};